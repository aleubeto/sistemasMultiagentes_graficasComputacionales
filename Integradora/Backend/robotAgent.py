...
class Room(Model):
    ...
    def __init__(self, height=30, width=30, space_rows=3, space_cols=3, length_wall=3, robots=40, boxes=5, shelves=40, step_counter=1, move_counter=0, boxstack_counter=0, time_limit=50, intelligence=False):
