...
const path = 'https://github.com/aleubeto/sistemasMultiagentes_graficasComputacionales/blob/nocheDesvelo/Integradora/Frontend/assets/Robot/scene.gltf'
